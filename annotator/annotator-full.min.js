...
((function() {
	...
	r = function(b) {
		...
		return c = this.map(function() {
			var c, d, e, f;
			e = "", c = this;
			while ((c != null ? c.nodeType :
			void 0) === Node.ELEMENT_NODE && c !== b) f = c.tagName.replace(":", "\\:"), d = a(c.parentNode).children(f).index(c) + 1, d = "[" + d + "]", e = "/" + c.tagName.toLowerCase() + d + e, c = c.parentNode;
			return e
		}), c.get()
	}, s = function(a) {
		var b, c, d, e;
		...
		return p(a)
	}, ( typeof jQuery != "undefined" && jQuery !== null ? ( z = jQuery.fn) != null ? z.jquery :
	void 0 :
	void 0) || console.error(E("Annotator requires jQuery: have you included lib/vendor/jquery.js?")), JSON && JSON.parse && JSON.stringify || console.error(E("Annotator requires a JSON implementation: have you included lib/vendor/json2.js?")), a = jQuery, f = {}, f.flatten = function(b) {
		var c;
		return c = function(b) {
			var d, e, f, g;
			e = [];
		...
		var d;
		console.log(a(c).offset(),b)
		return d = a(c).offset(),console.log(c), {
			top : b.pageY - d.top,
			left : b.pageX - d.left
		}
	}, f.preventEventDefault = function(a) {
		return a != null ? typeof a.preventDefault == "function" ? a.preventDefault() :
		void 0 :
		void 0
	...
	}(c), m = f.getGlobal(), (( A = m.document) != null ? A.evaluate :
	void 0) == null && a.getScript("http://assets.annotateit.org/vendor/xpath.min.js"), m.getSelection == null && a.getScript("http://assets.annotateit.org/vendor/ierange.min.js"), m.JSON == null && a.getScript("http://assets.annotateit.org/vendor/json2.min.js"), m.Node == null && (m.Node = {
		ELEMENT_NODE : 1,
		ATTRIBUTE_NODE : 2,
		TEXT_NODE : 3,
		...
		return H(d, c), d.prototype.events = {
			...
			delete b.highlights, a.extend(b, this.options.annotationData), c = JSON.stringify(b), d && (b.highlights = d), c
		...
		return H(d, c), d.prototype.events = {
			...
			return c ===
			void 0 && ( c = this.user), this.options.userAuthorize ? this.options.userAuthorize.call(this.options, a, b, c) : !0
		...
		function d(b, c) {
			...
			var e;
			b = a(this.html.element).appendTo((c != null ? c.appendTo :
			void 0) || this.options.appendTo), d.__super__.constructor.call(this, b, c), ( e = this.options).filters || (e.filters = []), this.filter = a(this.html.filter), this.filters = [], this.current = 0
		}
		return H(d, c), d.prototype.events = {
			...
			if (! function() {
				...
				e.id = "annotator-filter-" + e.property, e.annotations = [], e.element = this.filter.clone().appendTo(this.element), e.element.find("label").html(e.label).attr("for", e.id), e.element.find("input").attr({
					id : e.id,
			...
			}), e = (( k = b[0]) != null ? k.annotations :
			void 0) || [], b.length > 1 && ( d = [], a.each(b, function() {
		...
		function d(a, c) {
			this.updateTextField = I(this.updateTextField, this), ( typeof Showdown !== "undefined" && Showdown !== null ? Showdown.converter :
			void 0) != null ? (d.__super__.constructor.apply(this, arguments), this.converter = new Showdown.converter) : console.error(b._t("To use the Markdown plugin, you must include Showdown into the page first."))
		}
		return H(d, c), d.prototype.events = {
		...
		for ( k = 0, l = h.length; k < l; k++)
			e = h[k], e in g && !g[e] ? m.push(
			void 0) : m.push(this.addPlugin(e, g[e]));
		return m
	}
})).call(this); 